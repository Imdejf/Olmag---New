...
<template>
  <div style="background: #dbeafe">
    ...
    >
      <div
        class="flex-1 rounded-3xl bg-white shadow-xl p-[20px] text-gray-800 relative md:flex items-center text-center"
      >
        <div class="w-full md:w-1/2">
          <div class="mb-10 lg:mb-20">
            <img
              data-src="assets/logo.webp"
              class="lazyload w-[450px] h-[120px]"
            />
          </div>
          <div class="mb-10 md:mb-20 text-gray-600 font-light">
            ...
            <p>Spróbuj wyszukać ponownie lub użyj przycisku Wróć poniżej.</p>
          </div>
          <div class="mb-20 md:mb-0">
            <button
              @click="handleError"
              class="text-lg text-blue-600 font-600 font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-yellow-500 hover:text-yellow-600"
            >
              <i class="mdi mdi-arrow-left mr-2"></i>Wróć
            </button>
          </div>
        </div>
